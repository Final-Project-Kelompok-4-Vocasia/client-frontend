    ...
    login({ email, password }).then((response) => {
      ...
      if (!response.error) {
        ...
        if (response?.data?.isSeller) {
          ...
          //Navigasi ke halamana seller jika isAdmin === true
          navigate("/dashboard/seller");
        } else {
          toast.success("Selamat datang, Buyer!");
          //Navigasi ke hal seller jika isAdmin === false
        ...
        <form
          ...
          <div className="rounded-md">
            ...
            <div className="mb-2 block text-center">
              <Label className="text-base text-slate-700 text-center">Email:</Label>
            </div>
            <TextInput
              onChange={(event) => {
