...
function Card({ menuData, onClickItem }) {
  ...
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="/">
        <img
          className="flex mx-auto p-8 rounded-t-lg w-4/6 h-4/6 items-center"
          src={menuData.image}
          alt={menuData.namaMenu}
        />
      </a>
      <div className="px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          <span className="p-10 text-m font-bold text-gray-900 dark:text-white">
            {rupiah(menuData.harga)}
          </span>
