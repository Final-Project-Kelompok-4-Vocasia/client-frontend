  ...
  const navigateDashboardBuyer = (e) => {
    ...
    return (
      <div className=" my-16 flex items-center justify-center">
        <form className="max-w-full rounded-lg border-solid border-2 border-sky-500 m-8 p-14">
          <div className="mb-6">
            <h1 className="mb-4 font-bold text-lg">Register</h1>
            <label htmlFor="email" className="block mx-24 text-sm font-medium text-gray-900 dark:text-white">
              Username
            </label>
            <input
              type="email"
